...
class Parser:
	...
	def __init__(self, filepath):
		...
		self.__firstStructuredStatement = self.__firstConditionalStatement.union({Tag.REPEAT, Tag.WHILE})
	...
	# Creacion del while statement para reconocimiento
	...
	def __structuredStatement(self):
		if self.__token.getTag() in self.__firstStructuredStatement:
			...
			# Dentro del structure statement seleccionar si es while o repeat
